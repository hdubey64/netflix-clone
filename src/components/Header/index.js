...
import ChangeLanguage from "../atoms/Langauge";
...
const Header = () => {
   return (
      <div>
         <Navbar>
            <NavbarBrand href="/" className="brandLogo">
               <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="-253.6 -69.1855 1331.2 415.113"
               >
                  <path
                     fill="#e50914"
            ...
            <div className="navContent">
               <ChangeLanguage />
               <SignInButton buttonClass={"navBarButton"}>
                  {" "}
                  Sign In
               </SignInButton>
            </div>
